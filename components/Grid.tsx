...
const Grid = () => {
  ...
  return (
    <section id="about" className="py-20">
      {/* Hero Introduction */}
      <div className="relative mb-20 max-w-7xl mx-auto px-5">
        ...
        <div className="relative glass-card rounded-3xl p-8 md:p-12 border border-green-500/20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="mb-12">
              ...
              <div className="h-1 w-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full mx-auto mb-8"></div>
            </div>
            ...
            <div className="mb-12">
              <div className="glass-card rounded-3xl p-8 max-w-5xl mx-auto border-2 border-green-500/30 bg-gradient-to-br from-green-500/5 to-blue-500/5 hover:border-green-500/50 transition-all duration-300 shadow-lg hover:shadow-green-500/20">
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-center justify-center gap-6 mb-6">
                    <div className="text-center">
                      <div className="text-3xl font-bold primary-text mb-1">334+</div>
                      <div className="text-sm text-gray-400">Hours Worked</div>
                    </div>
                    <div className="w-px h-12 bg-green-500/30"></div>
                    <div className="text-center">
                      <div className="text-3xl font-bold secondary-text mb-1">5.0</div>
                      <div className="text-sm text-gray-400">Rating</div>
                    </div>
                    <div className="w-px h-12 bg-green-500/30"></div>
                    <div className="text-center">
                      <div className="text-lg font-bold accent-text mb-1">🌟</div>
                      <div className="text-sm text-gray-400">Rising Talent</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-black/20 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <span className="ml-3 text-sm text-gray-400">5.0 out of 5 • Recent Client Review</span>
                  </div>
                  ...
                  <div className="text-center">
                    <div className="text-white font-semibold">Jalal Ouissal</div>
                    <div className="text-sm text-gray-400">Apr 12, 2025 • Upwork Client</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {achievements.map((achievement, index) => (
                ...
                >
                  ...
                  <h4 className="text-sm font-bold text-white mb-2">{achievement.title}</h4>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                href="#projects"
                className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl font-semibold text-white hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-green-500/25 cursor-pointer"
              >
                View My Work
              </a>
              <a 
                ...
                className="px-6 py-3 glass-card border border-green-500/30 rounded-xl font-semibold text-green-300 hover:scale-105 hover:border-green-500/50 transition-all duration-300 cursor-pointer"
              >
                Download CV
              </a>
            </div>
