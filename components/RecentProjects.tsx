          ...
          {projects.map((project, index) => (
            ...
            >
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent transition-opacity duration-500 ${
                      ...
                      <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
                        <div className="flex justify-center">
                          <button className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white/20 backdrop-blur-md rounded-lg text-white hover:bg-white/30 transition-all duration-300">
                            <FaExternalLinkAlt className="text-sm" />
                            <span className="text-xs sm:text-sm font-medium">View Live Site</span>
                          </button>
                        </div>
                      </div>
                    </div>
              ...
              <div className="w-full lg:flex-1 space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 hover:primary-text transition-colors duration-300">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    {project.iconLists.map((tech, techIndex) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex items-center gap-2 px-3 sm:px-4 py-2 glass-card border border-green-500/20 rounded-xl hover:border-green-500/40 hover:scale-105 transition-all duration-300"
                      >
                        <Image
                          src={tech}
                          alt="Technology"
                ...
                <div className="pt-2 sm:pt-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl text-white font-semibold hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 transition-all duration-300 text-sm sm:text-base"
                  >
                    <FaExternalLinkAlt className="text-sm" />
                    View Live Site
                  </a>
