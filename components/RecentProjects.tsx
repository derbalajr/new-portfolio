          ...
          <div
            ...
            <PinContainer title={link} href={link}>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                {id === 3 || id === 4 ? (
            <>
              <p className="flex lg:text-xl md:text-xs text-sm text-lime-400">Local Application</p>
              <FaLock className="ms-3 text-lime-400" />
            </>
          ) : (
            <>
              <p className="flex lg:text-xl md:text-xs text-sm text-lime-400">Check Live Site</p>
